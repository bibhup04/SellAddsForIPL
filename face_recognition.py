...
class Face_Recognition:
    def __init__(self,root):
        ...
        #left image
        img_top=Image.open(r"college_images\recgo.jpeg")
        ...
        #right image
        img_right=Image.open(r"college_images\face_detector2.jpg")
        img_right=img_right.resize((950,750))
        ...
        b1_1.place(x=370,y=634,width=210,height=40)

    #==================attandance=========================
    def mark_attendance(self,i,r,n,d):
        with open('attn.csv','r+',newline="\n") as f:
            ...
            if((i not in name_list) and (r not in name_list) and (n not in name_list) and (d not in name_list)):
                f.writelines(f"{i},{r},{n},{d},{dtString},{d1},Present,{hou}\n")

            """
            print(entry[0],entry[4],entry[7])
            print('and   ',i,d1,hou)
            
            elif(i in name_list):
                for line in myDataList:
                    entry=line.split((","))
                    if ((entry[0]== i) and (entry[4] != d1)):
                        f.writelines(f"\n{i},{r},{n},{d},{dtString},{d1},Present")

                   # elif ((entry[0]== i) and (entry[4] == d1) and (entry[7] != hou)):
                    #    f.writelines(f"\n{i},{r},{n},{d},{dtString},{d1},Present")
        ...
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                if confidence > 77:
                    ...
                    cv2.putText(
                        img, f"Dep:{d}", (x, y-5), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 3)
